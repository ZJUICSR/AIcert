...
from dataset import ArgpDataLoader
from backdoor.backdoorattack import BackdoorAttack
from backdoor.badnets.tensorset import TensorSet


class Badnets(BackdoorAttack):
    def __init__(self, data_loader, **kwargs):
        assert isinstance(data_loader, ArgpDataLoader)
        super(Badnets, self).__init__(data_loader=data_loader, **kwargs)
