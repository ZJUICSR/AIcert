...
from function.attack.estimators.estimator import BaseEstimator, LossGradientsMixin, NeuralNetworkMixin
...
class PyTorchEstimator(NeuralNetworkMixin, LossGradientsMixin, BaseEstimator):
    ...
    def __init__(self, device, device_type: str = "gpu", **kwargs) -> None:
        """
