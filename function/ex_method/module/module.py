...
class Module(object):
    ...
    def lrp(self, R, labels, device, lrp_var=None,param=None):
        '''
    ...
    def _epsilon_lrp(self, R, param, device):
        raise NotImplementedError()
