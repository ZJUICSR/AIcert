...
# deflection = feature_squeeze(model = model, adv_nums=100, mean = mean, std = std, adv_method=adv_method, adv_dataset=adv_dataset, device=device)#, adv_examples='./dataset/adv_CIFAR10_FGSM.pt')
# deflection.detect()
