...
class at(object):
    ...
    def dataset(self):
        ...
        if self.adv_dataset == 'MNIST':
            ...
            trainset = torchvision.datasets.MNIST(root='/mnt/data2/yxl/AI-platform/dataset/MNIST', train=True, download=True, transform=transform_train)
            train_loader = DataLoader(trainset, batch_size=64, shuffle=True, **kwargs)
            testset = torchvision.datasets.MNIST(root='/mnt/data2/yxl/AI-platform/dataset/MNIST', train=False, download=True, transform=transform_test)
