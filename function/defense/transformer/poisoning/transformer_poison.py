...
class Transformerpoison(object):
    ...
    def train(self, detect_poison:Transformer, norm):
        ...
        def poison_dataset(x_clean, y_clean, percent_poison, poison_func, dataset=None):
            ...
            if dataset != None:
                ...
                for i in range(image_num):
                    output_dir = "/mnt/data2/yxl/AI-platform-test/output/backdoor/" + str(i)
                    ...
                    if i == 0:
                        save_jepg(x_poison_save[i] - x_clean_save[i], '/mnt/data2/yxl/AI-platform-test/output/trigger/trigger.jpeg', dataset)
        ...
        pil_image.save('/mnt/data2/yxl/AI-platform-test/output/trigger/trigger_predict.jpeg', "JPEG")
