...
from function.defense.preprocessor.create_inverse_gan_models import build_gan_graph, build_inverse_gan_graph, load_model
...
class Defense_gan(Prepro):
    ...
    def detect(self):
        ...
        mnist_model.load_weights("/mnt/data2/yxl/AI-platform/function/defense/preprocessor/mnist_model.h5")
