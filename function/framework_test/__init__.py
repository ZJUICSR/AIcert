...
def run_framework_test_exec(model, framework, out_path, logging=None):
    ...
    os.system("sudo docker exec -it framework_args bash -c 'cd /root/framework_test; source /etc/profile ; conda activate test_env ; python __init__argparse.py --model "+model+" --backend_list " +bl+" ' ")
