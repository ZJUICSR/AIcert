...
class Graph(kerastuner.HyperModel, serializable.Serializable):
    ...
    def _compile_keras_model(self, hp, model):
        ...
        optimizer_name = hp.Choice(
            ...
            # modify
            ["adam", "sgd", "adam_weight_decay",'nadam'],
            default="adam",
        )
        ...
        if optimizer_name == "adam":
            ...
            # modify
            sgd_mmt= hp.Choice(
            "momentum", [0.0 ,0.1,0.5,0.9,0.99], default=0,
            parent_name='optimizer', parent_values='sgd'
            )
            
            optimizer = tf.keras.optimizers.SGD(learning_rate=learning_rate,momentum=sgd_mmt)
        ...
        # modify
            ...
            # modify
            end_learning_rate = hp.Choice(
            "end_learning_rate", [1e-4,1e-5,2e-6,1e-6,0.0], default=0,#1e-5
            parent_name='optimizer', parent_values='adam_weight_decay'
            )#
            if learning_rate<10*end_learning_rate:
                end_learning_rate=learning_rate/10
            weight_decay_rate= hp.Choice(
            "weight_decay_rate", [0.001,0.005,0.01,0.05,0.1], default=0.01,
            parent_name='optimizer', parent_values='adam_weight_decay'
            )#
            ...
            lr_schedule = tf.keras.optimizers.schedules.PolynomialDecay(
                ...
                # end_learning_rate=0.0,# TODO: back
                # #modify
