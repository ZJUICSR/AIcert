...
class AutoModel(object):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if isinstance(tuner, str):
            # this line controls the tuner class
    ...
    def fit(
        ...
        **kwargs
        ...
        # # modify
        # x_sub,y_sub = x[:int(x.shape[0]*0.1),:,:,:],y[:int(y.shape[0]*0.1),:]
        # dataset_sub, validation_data_sub = self._convert_to_dataset(
        #     x=x_sub, y=y_sub, validation_data=None, batch_size=batch_size
        # )

        # dataset_sub, validation_data_sub = data_utils.split_dataset(
        #     dataset_sub, validation_split
        # )
        # kwargs['sub_dataset']=dataset_sub
        # kwargs['sub_validation_data']=validation_data_sub
