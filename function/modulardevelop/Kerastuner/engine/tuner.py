...
class Tuner(base_tuner.BaseTuner):
    ...
    def run_trial(self, trial, *fit_args, **fit_kwargs):
        ...
        # modify
        callbacks.append(tuner_utils.Record_History(fit_kwargs['root_path']))
        
        copied_fit_kwargs['callbacks'] = callbacks

        # # modify
        import autokeras
        if not isinstance(self,autokeras.tuners.dream.Dream):
            # del fit_kwargs['root_path']
            # del copied_fit_kwargs['root_path']
            ...
            self._build_and_fit_model_dream(trial, fit_args, copied_fit_kwargs)
