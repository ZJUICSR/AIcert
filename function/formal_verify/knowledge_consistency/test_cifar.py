...
device_ids = [1,0]
gpu = 1
model_path1 = "model_checkpoints/checkpoint_cifar10_vgg16_bn_lr-2_sd0.pth.tar"
model_path2 = "model_checkpoints/checkpoint_cifar10_vgg16_bn_lr-2_sd5.pth.tar"
image_path = "../image_cifar/"
resume = "./model_checkpoints/cifar10_vgg16_bn/checkpoint_L30__a0.1_lr-4.pth.tar"
dataset = 'cifar10'
conv_layer = 30
