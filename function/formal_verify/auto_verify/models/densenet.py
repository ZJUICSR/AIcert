...
def Densenet_mnist_32(in_ch=1, in_dim=28):
    return DenseNet(Bottleneck, [2,4,4], growth_rate=16)
if __name__ == "__main__":
    from thop import profile

    net = Densenet_mnist_32()
    x = torch.randn(1,1,28,28)
    y = net(x)
    print(net)
    macs, params = profile(net, (torch.randn(1, 1, 28, 28),))
