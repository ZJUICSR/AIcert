...
int8_t* cifar10_nn_run_cpa_dpa(Parameters* param){//uint8_t image_data[],q7_t conv1_wt[]
    q7_t* conv1_wt=NULL;
...
int8_t* cifar10_nn_run_hpa(Parameters* param){//uint8_t image_data[],q7_t conv1_wt[]
    ...
    // conv1 img_buffer2 -> img_buffer1
    // trigger_Pin_Pullup(); 
    arm_convolve_HWC_q7_RGB_mid_hpa(img_buffer2, CONV1_IM_DIM, CONV1_IM_CH, conv1_wt, CONV1_OUT_CH, CONV1_KER_DIM, CONV1_PADDING,
                            CONV1_STRIDE, conv1_bias, CONV1_BIAS_LSHIFT, CONV1_OUT_RSHIFT, img_buffer1, CONV1_OUT_DIM,
                            (q15_t *)col_buffer, NULL, param);
    // trigger_Pin_Nopull();
