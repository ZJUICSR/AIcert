...
int main(int argc, char const *argv[])
{
    ...
    #if 0 //-9
    char inFile[]="Trs/samples/cpa/elmotrace-9/(0.112.116.-9)elmotracegaus_cpa_-9.trs";
    char outFile[]="Trs/samples/cpa/elmotrace-9/cpa_out-9.txt";
    #endif

    #if 0 //2
    char inFile[]="Trs/samples/cpa/elmotrace2/(75.112.116.2)elmotracegaus_cpa_2.trs";
