...
def run(model,
    ...
    rules = Rules(model=model, dataloader=dataloader, eps=eps, attack_methods=methods, device=device, log_func=None)
    result['result'] = rules.run()
