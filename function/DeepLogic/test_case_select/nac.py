...
def nac_test(model, device,model_name,dataset_name,data,true_test):
    ...
    if dataset_name=='cifar':
        df.to_csv('./all_output/output_cifar/{}/{}_nac_0.csv'.format(model_name,dataset_name))
    if dataset_name=='fashionminist':
        df.to_csv('./all_output/output_fashionminist/{}/{}_nac_0.csv'.format(model_name,dataset_name))
