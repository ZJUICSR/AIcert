...
def run_robust_gcn(dataset_name, device=torch.device("cuda:0"), logger_func=print, **kwargs):
    training = RobustGCNTrain(params=kwargs, device=device, path=RESULT_ROOT)
